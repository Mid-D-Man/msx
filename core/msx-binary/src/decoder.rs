// core/msx-binary/src/decoder.rs
...
fn bad(msg: &str) -> io::Error { io::Error::new(io::ErrorKind::InvalidData, msg.to_string()) }
...
mod tests {
    use super::*;
    use crate::encoder::{write_paint, write_string_pool, write_style, write_transform, intern_string};
    use msx_ast::Color;
    ...
    #[test]
    fn font_weight_none_roundtrips_as_none() {
        let mut style = Style::empty();
    ...
    #[test]
    fn text_anchor_none_roundtrips_as_none() {
        let mut style = Style::empty();
